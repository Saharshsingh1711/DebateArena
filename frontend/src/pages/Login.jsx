                ...
                <div className="bg-bg/50 backdrop-blur-2xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3.5 mt-4 rounded-xl font-medium tracking-wide transition-all duration-300 transform active:scale-[0.98]
                    ...
                    <p className="mt-8 text-center text-sm text-t2">
                        ...
                        <Link to="/register" className="text-acc hover:text-emerald-300 transition-colors duration-200">
                            Register now
                        </Link>
                    </p>
                </div>
